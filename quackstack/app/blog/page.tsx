		...
		<div className='min-h-screen bg-black text-white'>
			...
			<section className='pt-24 pb-12 px-4 sm:px-6 lg:px-8'>
				<div className='max-w-7xl mx-auto text-center'>
					...
					<p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>Insights, tutorials, and thoughts from our development team. Stay updated with the latest trends in web development, design, and technology.</p>
				</div>
			</section>
					...
					<div className='max-w-7xl mx-auto'>
						...
						<div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
							{featuredPosts.map((post) => (
								<Card key={post.id} className='relative overflow-hidden group liquid-glass hover:liquid-glass-orange transition-all duration-500 rounded-xl'>
									...
									<CardContent className='p-6'>
										...
										<h3 className='text-xl font-bold text-white mb-3 group-hover:text-orange-400 transition-colors duration-300'>{post.title}</h3>
			...
			<section className='py-12 px-4 sm:px-6 lg:px-8'>
				<div className='max-w-7xl mx-auto'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
						{blogData.map((post) => (
							<Card key={post.id} className='relative overflow-hidden group liquid-glass hover:liquid-glass-orange transition-all duration-500 flex flex-col rounded-xl'>
								...
								<CardContent className='p-5 flex flex-col flex-1'>
									...
									<h3 className='text-lg font-bold text-white mb-3 group-hover:text-orange-400 transition-colors duration-300 line-clamp-2'>{post.title}</h3>
									<p className='text-gray-300 mb-4 leading-relaxed text-sm flex-1 line-clamp-3'>{post.excerpt}</p>
			...
			<section className='py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-500/10 to-transparent'>
				<div className='max-w-4xl mx-auto text-center'>
					...
					<p className='text-xl text-gray-300 mb-8'>Subscribe to our newsletter to get the latest insights and updates delivered to your inbox.</p>
					<div className='flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto'>
						<input type='email' placeholder='Enter your email' className='flex-1 px-4 py-3 bg-white/10 border border-orange-500/30 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-orange-400 backdrop-blur-sm' />
