...
The theatrical lighting system had occasional timing mismatches with the microcontroller. Sometimes lights would activate with a 100-200ms delay. Subtle, but enough to break immersion.
...
December 6-7, we were there. Not as performers, but as nervous system operators watching the lights.
...
This projec reminded us why we love what we do. Technology at its best is invisible. It enables experiences without drawing attention to itself. The Venus Labyrinth isn't about the Oracle Board. It's about consciousness, memory, choice, and connection. We just made sure the lights guided the way.
