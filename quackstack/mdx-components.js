			...
			return (
				<div className='min-h-screen bg-background text-foreground'>
					...
					<section className='py-12 px-4 sm:px-6 lg:px-8'>
						<div className='max-w-4xl mx-auto'>
							<article className='prose prose-lg dark:prose-invert max-w-none prose-headings:text-foreground prose-h1:text-orange-400 prose-h2:text-orange-400 prose-h3:text-foreground prose-a:text-orange-400 prose-a:no-underline hover:prose-a:text-orange-300 prose-strong:text-foreground prose-code:text-orange-300 prose-pre:bg-muted prose-pre:border prose-pre:border-orange-500/20 prose-p:text-foreground/80'>
								{children}
							</article>
						</div>
					</section>
