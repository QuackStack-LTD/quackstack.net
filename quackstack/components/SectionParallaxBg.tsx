...
const SectionParallaxBg: React.FC<{
	...
	return (
		<div ref={ref} id={id} className={`relative overflow-hidden ${className}`} style={style}>
			...
			{/* Top fade to black */}
			<div className='absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-black via-black/50 to-transparent -z-5 pointer-events-none' />

			{/* Bottom fade to black */}
			<div className='absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-black via-black/50 to-transparent -z-5 pointer-events-none' />
